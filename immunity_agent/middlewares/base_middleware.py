...
import os
import time
from immunity_agent.log.logger import logger_config
from concurrent.futures import ThreadPoolExecutor
from immunity_agent.setting import Setting
from immunity_agent.utils import scope
from immunity_agent.api import ClientAPI
...
class BaseMiddleware(object):
    ...
    def __init__(self, container):
        ...
        self.client = ClientAPI(self.setting)
