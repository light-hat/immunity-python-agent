...
class Instructions:
    ...
    def init_INTEGER(self):
        ...
        Set(
            "01",
            ["ADD"],
            [OPT.RM_FULL, OPT.REG_FULL],
            IFlag.MODRM_REQUIRED | IFlag.PRE_LOCK,
        )
        Set("02", ["ADD"], [OPT.REG8, OPT.RM8], IFlag.MODRM_REQUIRED | IFlag.PRE_LOCK)
        Set(
            "03",
            ["ADD"],
            [OPT.REG_FULL, OPT.RM_FULL],
            IFlag.MODRM_REQUIRED | IFlag.PRE_LOCK,
        )
        ...
        Set(
            ...
            ["SGDT"],
            [OPT.MEM16_3264],
            IFlag.MODRM_REQUIRED | IFlag._64BITS,
        )
        Set(
            "0f, 01 //01",
            ["SIDT"],
        ...
        Set(
            ...
            ["SMSW"],
            [OPT.RFULL_M16],
            IFlag.MODRM_REQUIRED | IFlag.NOT_DIVIDED,
        )
        Set(
            "0f, 01 //06",
            ["LMSW"],
        ...
        Set(
            "0f, 20",
            ["MOV"],
            [OPT.FREG32_64_RM, OPT.CREG],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag._64BITS,
        )
        Set(
            "0f, 21",
            ["MOV"],
            [OPT.FREG32_64_RM, OPT.DREG],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag._64BITS,
        )
        Set(
            "0f, 22",
            ["MOV"],
            [OPT.CREG, OPT.FREG32_64_RM],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag._64BITS,
        )
        Set(
            "0f, 23",
            ["MOV"],
            [OPT.DREG, OPT.FREG32_64_RM],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag._64BITS,
        )
        ...
        Set(
            ...
            ["BT"],
            [OPT.RM_FULL, OPT.REG_FULL],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "0f, a4",
            ["SHLD"],
            [OPT.RM_FULL, OPT.REG_FULL, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "0f, a5",
            ["SHLD"],
            [OPT.RM_FULL, OPT.REG_FULL, OPT.REGCL],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        ...
        Set(
            ...
            ["BTS"],
            [OPT.RM_FULL, OPT.REG_FULL],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_LOCK,
        )
        Set(
            "0f, ac",
            ["SHRD"],
        ...
        Set(
            ...
            ["FXSAVE", "", "FXSAVE64"],
            [OPT.MEM],
            IFlag.MODRM_REQUIRED
            | IFlag._32BITS
            | IFlag._64BITS
            | IFlag.PRE_REX
            | IFlag.USE_EXMNEMONIC2,
        )
        Set(
            "0f, ae /01",
            ["FXRSTOR", "", "FXRSTOR64"],
        ...
        Set(
            "0f, ae /02", ["LDMXCSR"], [OPT.MEM32], IFlag.MODRM_REQUIRED | IFlag._32BITS
        )
        Set(
            "0f, ae /03", ["STMXCSR"], [OPT.MEM32], IFlag.MODRM_REQUIRED | IFlag._32BITS
        )

        # MFENCE and XSAVEOPT share the same opcode 0f ae /6. It's MFENCE when MOD=11, else XSAVEOPT or XSAVEOPT64 in 64.
        Set(
            "0f, ae /06",
            ["MFENCE", "XSAVEOPT", "XSAVEOPT64"],
            [OPT.MEM_OPT],
            IFlag.MODRM_REQUIRED
            | IFlag._32BITS
            | IFlag.USE_EXMNEMONIC
            | IFlag.MNEMONIC_MODRM_BASED
            | IFlag._64BITS
            | IFlag.PRE_REX
            | IFlag.USE_EXMNEMONIC2,
        )
        ...
        Set(
            "0f, b2",
            ["LSS"],
            [OPT.REG_FULL, OPT.MEM16_FULL],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag._64BITS | IFlag.PRE_REX,
        )
        Set(
            "0f, b3",
            ["BTR"],
        ...
        Set(
            "0f, b6",
            ["MOVZX"],
            [OPT.REG_FULL, OPT.RM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "0f, b7",
            ["MOVZX"],
            [OPT.REG_FULL, OPT.RM16],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag._64BITS | IFlag.PRE_REX,
        )
        ...
        Set(
            ...
            ["BSWAP"],
            [OPT.IB_R_FULL],
            IFlag._32BITS | IFlag._64BITS | IFlag.PRE_REX | IFlag.GEN_BLOCK,
        )
        ...
        Set(
            "62",
            ["BOUND"],
            [OPT.REG_FULL, OPT.MEM],
            IFlag.MODRM_REQUIRED | IFlag.INVALID_64BITS,
        )
        Set("68", ["PUSH"], [OPT.IMM_FULL], IFlag._64BITS)
        Set(
            "69",
            ["IMUL"],
            [OPT.REG_FULL, OPT.RM_FULL, OPT.IMM_FULL],
            IFlag.MODRM_REQUIRED,
        )
        ...
        Set(
            "6b",
            ["IMUL"],
            [OPT.REG_FULL, OPT.RM_FULL, OPT.SEIMM8],
            IFlag.MODRM_REQUIRED,
        )
        ...
        Set(
            "6c", ["INS"], [OPT.REGI_EDI, OPT.REGDX], IFlag.PRE_REPNZ | IFlag.PRE_REP
        )  # 8 bit.
        Set(
            "6d",
            ["INS"],
            [OPT.REGI_EDI, OPT.REGDX],
            IFlag._16BITS | IFlag.PRE_REPNZ | IFlag.PRE_REP,
        )  # Full size.
        Set(
            "6e", ["OUTS"], [OPT.REGDX, OPT.REGI_ESI], IFlag.PRE_REPNZ | IFlag.PRE_REP
        )  # 8 bit.
        Set(
            "6f",
            ["OUTS"],
            [OPT.REGDX, OPT.REGI_ESI],
            IFlag._16BITS | IFlag.PRE_REPNZ | IFlag.PRE_REP,
        )  # Full size.
        ...
        Set(
            "80 /01", ["OR"], [OPT.RM8, OPT.IMM8], IFlag.MODRM_REQUIRED | IFlag.PRE_LOCK
        )
        Set(
            "80 /02",
            ["ADC"],
        ...
        Set(
            ...
            ["ADD"],
            [OPT.RM8, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag.PRE_LOCK | IFlag.INVALID_64BITS,
        )
        Set(
            "82 /01",
            ["OR"],
        ...
        Set(
            ...
            ["CBW", "CWDE", "CDQE"],
            [],
            IFlag.USE_EXMNEMONIC | IFlag.USE_EXMNEMONIC2,
        )
        Set(
            "99",
            ["CWD", "CDQ", "CQO"],
        ...
        Set(
            "a4",
            ["MOVS"],
            [OPT.REGI_EDI, OPT.REGI_ESI],
            IFlag.PRE_REPNZ | IFlag.PRE_REP,
        )
        Set(
            "a5",
            ["MOVS"],
        ...
        Set(
            "b8",
            ["MOV"],
            [OPT.IB_R_FULL, OPT.IMM_FULL],
            IFlag._64BITS | IFlag.PRE_REX | IFlag.GEN_BLOCK,
        )
        ...
        Set(
            ...
            ["JCXZ", "JECXZ", "JRCXZ"],
            [OPT.RELCB],
            IFlag.PRE_ADDR_SIZE | IFlag.USE_EXMNEMONIC | IFlag.USE_EXMNEMONIC2,
        )
        ...
        Set(
            ...
            ["CALL FAR"],
            [OPT.MEM16_FULL],
            IFlag.MODRM_REQUIRED | IFlag._64BITS | IFlag.PRE_REX,
        )
        ...
        Set(
            ...
            ["LZCNT"],
            [OPT.REG_FULL, OPT.RM_FULL],
            IFlag.MODRM_REQUIRED | IFlag.PRE_OP_SIZE,
        )
    ...
    def init_Exported(self):
        ...
        Set(
            "63",
            ["MOVSXD"],
            [OPT.REG32_64, OPT.RM32],
            IFlag.MODRM_REQUIRED | IFlag._64BITS | IFlag.PRE_REX | IFlag.EXPORTED,
        )
        ...
        Set(
            ...
            ["_3DNOW"],
            [OPT.MM, OPT.MM64],
            IFlag.MODRM_REQUIRED | IFlag._3DNOW_FETCH | IFlag.EXPORTED,
        )
    ...
    def init_FPU(self):
        ...
        Set(
            ...
            ["FSTENV"],
            [OPT.MEM],
            IFlag.PRE_OP_SIZE | IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "9b, d9 //07",
            ["FSTCW"],
    ...
    def init_P6(self):
        ...
        Set(
            "0f, 34", ["SYSENTER"], [], IFlag._32BITS
        )  # Only AMD states invalid in 64 bits.
        Set(
            "0f, 35", ["SYSEXIT"], [], IFlag._32BITS
        )  # Only AMD states invalid in 64 bits.
        Set(
            "0f, 40",
            ["CMOVO"],
    ...
    def init_MMX(self):
        ...
        Set(
            "0f, 6f", ["MOVQ"], [OPT.MM, OPT.MM64], IFlag.MODRM_REQUIRED | IFlag._32BITS
        )
        Set(
            "0f, 71 /02",
            ["PSRLW"],
            [OPT.MM_RM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.MODRR_REQUIRED,
        )
        Set(
            "0f, 71 /04",
            ["PSRAW"],
        ...
        Set(
            "0f, 7f", ["MOVQ"], [OPT.MM64, OPT.MM], IFlag.MODRM_REQUIRED | IFlag._32BITS
        )
        Set(
            "0f, d1",
            ["PSRLW"],
        ...
        Set(
            "0f, db", ["PAND"], [OPT.MM, OPT.MM64], IFlag.MODRM_REQUIRED | IFlag._32BITS
        )
        Set(
            "0f, dc",
            ["PADDUSB"],
        ...
        Set(
            "0f, ef", ["PXOR"], [OPT.MM, OPT.MM64], IFlag.MODRM_REQUIRED | IFlag._32BITS
        )
        Set(
            "0f, f1",
            ["PSLLW"],
    ...
    def init_SSE(self):
        ...
        Set(
            "0f, c4",
            ["PINSRW"],
            [OPT.MM, OPT.R32_M16, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "0f, c5",
            ["PEXTRW"],
            [OPT.REG32, OPT.MM_RM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.MODRR_REQUIRED,
        )
        Set(
            "0f, c6",
            ["SHUFPS"],
            [OPT.XMM, OPT.XMM128, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "0f, d7",
    ...
    def init_SSE2(self):
        ...
        Set(
            "66, 0f, c4",
            ["PINSRW"],
            [OPT.XMM, OPT.R32_M16, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "66, 0f, c5",
            ["PEXTRW"],
            [OPT.REG32, OPT.XMM_RM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "66, 0f, c6",
    ...
    def init_SSE4_1(self):
        ...
        Set(
            "66, 0f, 38, 15",
            ["BLENDVPD"],
            [OPT.XMM, OPT.XMM128, OPT.REGXMM0],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "66, 0f, 38, 14",
        ...
        Set(
            "66, 0f, 3a, 14",
            ["PEXTRB"],
            [OPT.R32_64_M8, OPT.XMM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "66, 0f, 3a, 16",
            ["PEXTRD", "", "PEXTRQ"],
            [OPT.RM32_64, OPT.XMM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.USE_EXMNEMONIC2,
        )
        Set(
            "66, 0f, 3a, 15",
            ["PEXTRW"],
            [OPT.R32_64_M16, OPT.XMM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "66, 0f, 38, 41",
        ...
        Set(
            "66, 0f, 3a, 20",
            ["PINSRB"],
            [OPT.XMM, OPT.R32_M8, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "66, 0f, 3a, 22",
            ["PINSRD", "", "PINSRQ"],
            [OPT.XMM, OPT.RM32_64, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.USE_EXMNEMONIC2,
        )
        Set(
            "66, 0f, 38, 3c",
    ...
    def init_SSE4_2(self):
        ...
        Set(
            "f2, 0f, 38, f0",
            ["CRC32"],
            [OPT.REG32_64, OPT.RM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "f2, 0f, 38, f1",
            ["CRC32"],
            [OPT.REG32_64, OPT.RM_FULL],
            IFlag.MODRM_REQUIRED | IFlag._32BITS,
        )
        Set(
            "66, 0f, 38, 17",
        ...
        Set(
            ...
            ["POPCNT"],
            [OPT.REG_FULL, OPT.RM_FULL],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_OP_SIZE,
        )
    ...
    def init_SSE4_A(self):
        ...
        Set(
            "66, 0f, 78",
            ["EXTRQ"],
            [OPT.XMM_RM, OPT.IMM8_1, OPT.IMM8_2],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.FORCE_REG0,
        )
        Set(
            "66, 0f, 79",
            ["EXTRQ"],
        ...
        Set(
            "f2, 0f, 78",
            ["INSERTQ"],
            [OPT.XMM, OPT.XMM_RM, OPT.IMM8_1, OPT.IMM8_2],
            IFlag.MODRM_REQUIRED | IFlag.MODRR_REQUIRED | IFlag._32BITS,
        )
        Set(
            "f2, 0f, 79",
            ["INSERTQ"],
    ...
    def init_3DNOW(self):
        ...
        Set(
            "0f, 0d /01", ["PREFETCHW"], [OPT.MEM], IFlag.MODRM_REQUIRED | IFlag._32BITS
        )
        ...
        Set(
            ...
            ["PI2FD"],
            [OPT.MM, OPT.MM64],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag._3DNOW_FETCH,
        )
        Set(
            "0f, 0f, 1d",
            ["PF2ID"],
    ...
    def init_AVX(self):
        ...
        Set(
            "66, 0f, 58",
            ["VADDPD"],
            [OPT.YXMM, OPT.VYXMM, OPT.YXMM128_256],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.VEX_L,
        )
        Set(
            "0f, 58",
            ["VADDPS"],
        ...
        Set(
            "f2, 0f, 58",
            ["VADDSD"],
            [OPT.XMM, OPT.VXMM, OPT.XMM64],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX,
        )
        Set(
            "f3, 0f, 58",
            ["VADDSS"],
            [OPT.XMM, OPT.VXMM, OPT.XMM32],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX,
        )
        ...
        Set(
            "66, 0f, 3a, 0d",
            ["VBLENDPD"],
            [OPT.YXMM, OPT.VYXMM, OPT.YXMM128_256, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.VEX_L,
        )
        Set(
            "66, 0f, 3a, 0c",
        ...
        Set(
            "66, 0f, 3a, 4b",
            ["VBLENDVPD"],
            [OPT.YXMM, OPT.VYXMM, OPT.YXMM128_256, OPT.YXMM_IMM],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.VEX_L,
        )
        Set(
            "66, 0f, 3a, 4a",
        ...
        Set(
            ...
            ["VBROADCASTSD"],
            [OPT.YMM, OPT.MEM64],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.FORCE_VEXL,
        )
        Set(
            "66, 0f, 38, 1a",
            ["VBROADCASTF128"],
        ...
        Set(
            ...
            ["VCMP", "SD"],
            [OPT.XMM, OPT.VXMM, OPT.XMM64],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.PSEUDO_OPCODE,
        )
        Set(
            "f3, 0f, c2",
            ["VCMP", "SS"],
        ...
        Set(
            "f3, 0f, e6",
            ["VCVTDQ2PD"],
            [OPT.YXMM, OPT.LXMM64_128],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.VEX_L,
        )
        Set(
            "0f, 5b",
            ["VCVTDQ2PS"],
            [OPT.YXMM, OPT.YXMM128_256],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.VEX_L,
        )
        Set(
            "f2, 0f, e6",
            ["VCVTPD2DQ"],
            [OPT.XMM, OPT.YXMM128_256],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.VEX_L,
        )
        Set(
            "66, 0f, 5a",
        ...
        Set(
            "f2, 0f, 2d",
            ["VCVTSD2SI"],
            [OPT.WREG32_64, OPT.WXMM32_64],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.VEX_W,
        )
        Set(
            "f2, 0f, 5a",
            ["VCVTSD2SS"],
        ...
        Set(
            "66, 0f, 3a, 19",
            ["VEXTRACTF128"],
            [OPT.XMM128, OPT.YMM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.FORCE_VEXL,
        )
        Set(
            "66, 0f, 3a, 17",
            ["VEXTRACTPS"],
            [OPT.RM32, OPT.XMM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX,
        )
        ...
        Set(
            ...
            ["VMASKMOVDQU"],
            [OPT.XMM, OPT.XMM_RM],
            IFlag.MODRM_REQUIRED | IFlag.MODRR_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX,
        )

        Set(
            "66, 0f, 38, 2c",
            ["VMASKMOVPS"],
            [OPT.YXMM, OPT.VYXMM, OPT.LMEM128_256],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.VEX_L,
        )
        Set(
            "66, 0f, 38, 2d",
        ...
        Set(
            "66, 0f, 38, 2e",
            ["VMASKMOVPS"],
            [OPT.LMEM128_256, OPT.VYXMM, OPT.YXMM],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.VEX_L,
        )
        Set(
            "66, 0f, 38, 2f",
        ...
        Set(
            "66, 0f, 6e",
            ["VMOVD", "VMOVQ"],
            [OPT.XMM, OPT.WRM32_64],
            IFlag.MODRM_REQUIRED
            | IFlag._32BITS
            | IFlag.PRE_VEX
            | IFlag.VEX_W
            | IFlag.MNEMONIC_VEXW_BASED,
        )
        Set(
            "66, 0f, 7e",
            ["VMOVD", "VMOVQ"],
            [OPT.WRM32_64, OPT.XMM],
            IFlag.MODRM_REQUIRED
            | IFlag._32BITS
            | IFlag.PRE_VEX
            | IFlag.VEX_W
        ...
        Set(
            "66, 0f, 50",
            ["VMOVMSKPD"],
            [OPT.REG32_64, OPT.YXMM],
            IFlag.MODRM_REQUIRED
            | IFlag.MODRR_REQUIRED
            | IFlag._32BITS
            | IFlag._64BITS
            | IFlag.PRE_VEX
            | IFlag.VEX_L,
        ...
        Set(
            "66, 0f, 3a, 4c",
            ["VPBLENDVB"],
            [OPT.XMM, OPT.VXMM, OPT.XMM128, OPT.XMM_IMM],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX,
        )
        Set(
            "66, 0f, 3a, 0e",
        ...
        Set(
            "66, 0f, 3a, 06",
            ["VPERM2F128"],
            [OPT.YMM, OPT.VYMM, OPT.YMM256, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.FORCE_VEXL,
        )
        ...
        Set(
            "66, 0f, 3a, 14",
            ["VPEXTRB"],
            [OPT.REG32_64_M8, OPT.XMM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag._64BITS | IFlag.PRE_VEX,
        )
        Set(
            "66, 0f, c5",
            ["VPEXTRW"],
            [OPT.REG32_64, OPT.XMM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag._64BITS | IFlag.PRE_VEX,
        )
        Set(
            "66, 0f, 3a, 15",
            ["VPEXTRW"],
            [OPT.REG32_64_M16, OPT.XMM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag._64BITS | IFlag.PRE_VEX,
        )
        Set(
            "66, 0f, 3a, 16",
            ["VPEXTRD", "VPEXTRQ"],
            [OPT.WRM32_64, OPT.XMM, OPT.IMM8],
            IFlag.MODRM_REQUIRED
            | IFlag._32BITS
            | IFlag.PRE_VEX
            | IFlag.VEX_W
        ...
        Set(
            "66, 0f, 3a, 20",
            ["VPINSRB"],
            [OPT.XMM, OPT.VXMM, OPT.REG32_64_M8, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX,
        )
        Set(
            "66, 0f, c4",
            ["VPINSRW"],
            [OPT.XMM, OPT.VXMM, OPT.R32_M16, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX,
        )
        Set(
            "66, 0f, 3a, 22",
            ["VPINSRD", "VPINSRQ"],
            [OPT.XMM, OPT.VXMM, OPT.WRM32_64, OPT.IMM8],
            IFlag.MODRM_REQUIRED
            | IFlag._32BITS
            | IFlag.PRE_VEX
            | IFlag.VEX_W
        ...
        Set(
            "66, 0f, 73 /07",
            ["VPSLLDQ"],
            [OPT.VXMM, OPT.XMM_RM, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX | IFlag.MODRR_REQUIRED,
        )
        Set(
            "66, 0f, 73 /03",
            ["VPSRLDQ"],
        ...
        Set(
            "66, 0f, 3a, 0b",
            ["VROUNDSD"],
            [OPT.XMM, OPT.VXMM, OPT.XMM64, OPT.IMM8],
            IFlag.MODRM_REQUIRED | IFlag._32BITS | IFlag.PRE_VEX,
        )
        Set(
            "66, 0f, 3a, 0a",
        ...
        Set(
            ...
            ["VZEROUPPER", "VZEROALL"],
            [],
            IFlag._32BITS | IFlag.PRE_VEX | IFlag.VEX_L | IFlag.MNEMONIC_VEXL_BASED,
        )
    ...
    def init_FMA(self):
        ...
        Set(
            ...
            [OPT.XMM, OPT.VXMM, OPT.WXMM32_64],
            IFlag.MODRM_REQUIRED
            | IFlag._32BITS
            | IFlag.PRE_VEX
            | IFlag.VEX_W
